...
CASES = {
    ...
    "doklad": [
        ("ВВЕДЕНИЕ", 1, TXT, []),
        ("1 Ключевые понятия и теоретические основы темы", 1, TXT, []),
    ...
    "esse": [
        ("ВВЕДЕНИЕ", 1, TXT, []),
        ("1 Постановка проблемы и первый аргумент", 1, TXT, []),
        ("2 Второй аргумент, контраргументы и авторская позиция", 1, TXT, []),
        ("ЗАКЛЮЧЕНИЕ", 1, TXT, []),
        ("СПИСОК ИСПОЛЬЗОВАННЫХ ИСТОЧНИКОВ", 1, BIB, []),
    ],
    "article": [
        ("АННОТАЦИЯ И КЛЮЧЕВЫЕ СЛОВА", 1, TXT, []),
        ("ВВЕДЕНИЕ", 1, TXT, []),
